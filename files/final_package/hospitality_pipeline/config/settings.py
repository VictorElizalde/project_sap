"""
config/settings.py — Hospitality Pipeline
==========================================
THE ONLY FILE YOU NEED TO EDIT.
Fill in your credentials here before running.
"""
import os
...
class PowerBISettings:
    ...
    datasets: dict = field(default_factory=lambda: {
        "RAWventas_hospitality": os.getenv("PBI_DATASET_VENTAS_HOSP",    ""),
        "RAWalbaranes":          os.getenv("PBI_DATASET_ALBARANES",       ""),
        "RAWclientes":           os.getenv("PBI_DATASET_CLIENTES",        ""),
